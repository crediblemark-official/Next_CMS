...
// src/HeadingAnalyzer.tsx
import { createUseCredBuild } from "@credbuild/core";
...
var useCredBuild = createUseCredBuild();
var HeadingAnalyzer = () => {
    ...
    /* @__PURE__ */ jsxs(
      "small",
      {
        ...
        children: [
          ...
          " ",
          /* @__PURE__ */ jsx2("a", { href: "https://github.com/credbuild/credbuild/blob/main/packages/plugin-heading-analyzer/README.md", children: "README" }),
          "."
        ]
      }
    ),
