...
const PortfolioRender = ({ title, subtitle }: PortfolioProps) => {
    ...
    if (items.length === 0) return <div className="p-10 text-center text-gray-400">No projects found. Please add them in the Dashboard!</div>;
